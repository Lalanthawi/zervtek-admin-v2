...
interface AssignTranslatorDrawerProps {
  open: boolean
...
export function AssignTranslatorDrawer({
  open,
  onOpenChange,
  request,
  onAssign,
}: AssignTranslatorDrawerProps) {
      ...
      <SheetContent className='flex flex-col gap-0 p-0 sm:max-w-lg'>
        ...
        <div className='border-b bg-muted/30'>
          <SheetHeader className='p-4 pb-0'>
            ...
            <SheetDescription>
              Assign a staff member to handle this translation request
            </SheetDescription>
          </SheetHeader>
            ...
            {!selectedStaff && searchResults.length === 0 && (
              <div className='flex flex-col items-center justify-center py-8 text-center'>
                ...
                <p className='mt-1 text-sm text-muted-foreground'>
                  Enter a name or email to find the translator
                </p>
              </div>
            )}
          </div>
